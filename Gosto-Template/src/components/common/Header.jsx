...
export const Header = () => {
  ...
  const handleBuy = () => {
    ...
    axios
      .post(
        "http://127.0.0.1:8000/Admin/Bought",getdata,
        {
          headers: {
            ...
            <div className="right_user">
              ...
              {isLoggedIn === false ? (
                ...
                <Link onClick={logout} to="/home">
                  <i className="logout__icon fal fa-sign-out-alt"></i>
                </Link>
              )}
            </div>
              ...
              <div className={cartList ? "showCart" : "hideCart"}>
                {getdata.length ? (
                  <section className="details">
                    ...
                    <button onClick={() => handleBuy()} className="secondary_button">Buy</button>
                  </section>
                ) : (
                  <div className="empty">
